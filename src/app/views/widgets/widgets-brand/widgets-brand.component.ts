...
export class WidgetsBrandComponent implements AfterContentInit {
  ...
  brandData: BrandData[] = [
    {
      icon: 'cilTruck',
      values: [{ title: 'عدد القطع', value: '3000' }, { title: 'النواقص', value: '459' }],
      capBg: { '--cui-card-cap-bg': '#3b5998' },
      labels: [...this.labels],
      data: {
        labels: [...this.labels],
        datasets: [{ ...this.datasets, data: [65, 59, 84, 84, 51, 55, 40], label: 'قطعة', ...this.colors }]
      }
    },
    {
      icon: 'cilCog',
      values: [{ title: 'الالات', value: '33' }, { title: 'يحاتج لصيانة', value: '4' }],
      capBg: { '--cui-card-cap-bg': '#00aced' },
      data: {
        labels: [...this.labels],
        datasets: [{ ...this.datasets, data: [1, 13, 9, 17, 34, 41, 38], label: 'ماكينة', ...this.colors }]
      }
    },
    {
      icon: 'cilGroup',
      values: [{ title: 'موظفين', value: '200' }, { title: 'الكفائة', value: '73%' }],
      capBg: { '--cui-card-cap-bg': '#4875b4' },
      data: {
        labels: [...this.labels],
        datasets: [{ ...this.datasets, data: [200, 200, 200, 201, 200, 2003, 2005], label: 'LinkedIn', ...this.colors }]
      }
    }
  ];
